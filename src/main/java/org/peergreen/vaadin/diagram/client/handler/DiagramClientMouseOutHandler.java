 ...
 */
public class DiagramClientMouseOutHandler extends DiagramMouseEventHandler implements MouseOutHandler {

    public DiagramClientMouseOutHandler(DiagramConnector diagramConnector, ClientStateModel clientStateModel) {
